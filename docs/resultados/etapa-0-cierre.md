...
| La guía tiene las 18 definiciones con ejemplos | Sí | `docs/guia-anotacion.md` define los 5 tipos y las 18 relaciones, cada una con definición, ≥ 3 ejemplos y ≥ 2 «no es»; lo comprueba `enrel/anotacion/guia.py:cargar_guia` y `tests/test_guia.py`. |
